...
import math
from src.kernel import exponential_kernel,exponential_kernel_tfed
import numpy as np
import random
import pickle
...
for length_scale in length_scales:
    ...
    gpp_estimation = GPPEstimation(dis_data, exponential_kernel_tfed, knots, weights_full)
    initial_params=gpp_estimation.argument2vector(mu,Sigma,beta,delta,theta)
    result_stage1=gpp_estimation.dis_opimize_stage1(initial_params,T=10000,noisy=True)
