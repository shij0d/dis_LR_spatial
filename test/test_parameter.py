...
for length_scale in length_scales:
    ...
    # result_stage1=gpp_estimation.dis_opimize_stage1(initial_params,T=200,noisy=True)
    ...
    #     delta_list[j]=delta
    #     theta_list[j]=theta
    result=gpp_estimation.ce_optimize_stage2(mu,Sigma,beta,delta,theta,T=50)

    result=gpp_estimation.de_optimize_stage2(mu_list,Sigma_list,beta_list,delta_list,theta_list,T=50)
    with open(f'./test/test_parameter_length_scale_{length_scale}.pkl', 'wb') as f:
