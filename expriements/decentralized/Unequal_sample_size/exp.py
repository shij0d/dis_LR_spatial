...
def estimate(r):
    ...
    data1=data[0:2000,]
    data2=data[2000:,]
    dis_data1=sampler.data_split(data1,5)
    dis_data2=sampler.data_split(data2,8)
    dis_data=dis_data1+dis_data2
...
for i, result in results:
    results[i] = result
with open(f'/home/shij0d/documents/dis_LR_spatial/expriements/decentralized/Unequal_sample_size/res.pkl', 'wb') as f:
    pickle.dump(results, f)