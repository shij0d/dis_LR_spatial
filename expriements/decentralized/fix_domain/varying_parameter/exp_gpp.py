...
def estimate(r,length_scale,nu,rank):
    ...
    data,knots=sampler.generate_obs_gpp(m=rank,method="grid")
...
dir='/home/shij0d/Documents/Dis_Spatial/expriements/decentralized/fix_domain/varying_parameter/'
for nu_length in nu_lengths:
    ...
    with open(f'{dir}/gpp_nu_{nu}_length_scale_{length_scale_act}_rank_{rank}_grid_memeff.pkl', 'wb') as f:
