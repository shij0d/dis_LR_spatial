...
for N in Ns:
    ...
    # with open(f'expriements/decentralized/varying_sample_size/N_{N}.pkl', 'wb') as f:
    ...
    for i, result in results:
        results[i] = result
    dir='/home/shij0d/Documents/Dis_Spatial/expriements/decentralized/fix_domain/varying_sample_size/'
    #create the directory if it doesn't exist
    if not os.path.exists(dir):
        os.makedirs(dir)
    with open(f'{dir}/gpp_N_{N}_memeff.pkl', 'wb') as f:
        pickle.dump(results, f)
