...
rs=[r for r in range(25)]
nus=np.arange(1.2, 1.9, 0.1)
nu_true=1.53
# Parallel execution for the list of rs, while maintaining the index (i)
results = Parallel(n_jobs=-1)(
    delayed(estimate)(r,nu,nu_true) for  r in rs for nu in nus
)
with open(f'expriements/decentralized/estimating_nu/r_range(25)_nu_{nu_true}.pkl', 'wb') as f:
